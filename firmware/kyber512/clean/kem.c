...
#ifndef DISABLE_BENCH_MARKING_L1
    time (End_Time);
    fprintf(stdout, "L1:PQCLEAN_KYBER1024_CLEAN_indcpa_enc cycles = %ld, begin:%ld, end:%ld\n", End_Time - Begin_Time,Begin_Time,End_Time);
#endif // DISABLE_BENCH_MARKING_L1
...
#ifndef DISABLE_BENCH_MARKING_L1
    time (End_Time);
    fprintf(stdout, "L1:PQCLEAN_KYBER512_CLEAN_indcpa_dec cycles = %ld, begin:%ld, end:%ld\n", End_Time - Begin_Time,Begin_Time,End_Time);
#endif // DISABLE_BENCH_MARKING_L1
